...
describe('About Page', () => {
  test('renders about heading', () => {
    ...
    expect(screen.getByText('About WayMaker')).toBeInTheDocument();
  });
  ...
  test('renders feature list', () => {
    ...
    expect(
      screen.getByText(/Interactive map with multiple layers/)
    ).toBeInTheDocument();
  });
  ...
  test('renders technology stack', () => {
    ...
    expect(
      screen.getByText(/Leaflet for interactive mapping/)
    ).toBeInTheDocument();
