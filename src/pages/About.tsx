      ...
      <div className="max-w-4xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-lg shadow-md p-8">
          ...
          <div className="prose prose-lg text-gray-600">
            <p className="mb-6">
              WayMaker is a modern web application built with React that
              provides powerful route planning capabilities using the
              OpenRouteService API. Whether you're planning a walking route,
              cycling adventure, or driving directions, our application offers
              comprehensive mapping solutions to guide your path to adventure.
            </p>
